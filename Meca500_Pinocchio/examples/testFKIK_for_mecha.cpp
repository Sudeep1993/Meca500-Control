...
int main(int argc, char** argv)
{
    ...
    kinematics.setRobotUrdf("../urdfs/Meca_500_urdf-R2/Meca_500_urdf-R2/urdf/Meca_500_urdf-R2.urdf", "../urdfs/Meca_500_urdf-R2/");
    ...
    bool success = kinematics.inverse(pose, joint_angles, false, true, false);
